    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div className="flex-none gap-4">
                ...
                {/* User variable is passed in here. It check if the user logged in or not. If the user is logged in then it will show the dropdown menu if not then it will show the login button and register button instead. */}
                {user && (
                    <div className="dropdown dropdown-end">
                        <div
                            tabIndex={0}
